    ...
    <v-col class="py-4">
            ...
            <v-menu offset-y>
              ...
              <v-list nav dense>
                ...
                <v-list-item @click="editItem(item)">
                  ...
                  <v-list-item-content>
                    <v-list-item-title>Edit Keterangan</v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
      ...
      <v-dialog v-model="dialogTerbit" max-width="500px">
        <v-card>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="red darken-1" text @click="dialogTerbit = false">Cancel</v-btn>
            <v-btn color="green darken-1" text @click="terbitItemConfirm">Ya</v-btn>
            <v-spacer></v-spacer>
          </v-card-actions>
        </v-card>
      </v-dialog>
