  ...
  <v-row justify="center" align="center">
    <v-col class="py-4">
      <v-alert border="left" color="teal lighten-1" class="text-subtitle-3 font-weight-bold  white--text">
        Pengajuan Surat Pengantar Keterangan Kelahiran
      </v-alert>

      <div class="">
        <v-card>
          <v-card-text class="py-2 text-subtitle-1 font-weight-bold text-center black--text">Form Pengajuan Surat
            Pengantar Penerbitan Keterangan Kelahiran</v-card-text>
          <v-form ref="form" v-model="valid" lazy-validation class="px-12 py-6 mx-12">
            <v-container>
              <v-row align="center" class="py-2">
                ...
                <v-col cols="1">:</v-col>
                <v-col cols="3">
                  <v-text-field value="Surat Pengantar Keterangan Kelahiran" :rules="alamatRules" label="Jenis Surat" solo required
