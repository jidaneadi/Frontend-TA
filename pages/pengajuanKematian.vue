          ...
          <v-form ref="form" v-model="valid" lazy-validation class="px-12 py-6 mx-12">
            <v-container>
              <v-row align="center" class="py-2">
                ...
                <v-col cols="1">:</v-col>
                <v-col cols="3">
                  <v-text-field value="Surat Pengantar Keterangan Kematian" :rules="alamatRules" label="Jenis Surat" solo required
      ...
      abaout: [
        {
          ...
          jawaban: 'Persyaratan yang diperlukan untuk mengajukan permohonan penerbitan surat pengantar Keterangan Kematian adalah file scan KK berformat PDF'
        },
        {
