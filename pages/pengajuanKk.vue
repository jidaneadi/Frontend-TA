    ...
    <v-col class="py-4">
      <!-- <v-card>
        <v-tabs background-color="grey lighten-4" center-active dark>
          <v-tab class="text-center black--text">Pengajuan Surat Pengantar KK</v-tab>
        </v-tabs>
      </v-card> -->
      ...
      <div class="">
        <v-card>
          <v-card-text class="py-2 text-subtitle-1 font-weight-bold text-center black--text">Form Pengajuan Surat
            Pengantar Penerbitan KK</v-card-text>
          <v-form ref="form" v-model="valid" lazy-validation class="px-12 py-6 mx-12">
            <v-container>
              <v-row align="center" class="py-2">
                ...
                <v-col cols="1">:</v-col>
                <v-col cols="3">
                  <v-text-field value="Surat Pengantar KK" :rules="alamatRules" label="Jenis Surat" solo required
