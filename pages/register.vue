...
export default {
  ...
  methods: {
    onSubmit() {
      this.$axios.$post('http://127.0.0.1:4000/auth/register', this.form)
        .then((response) => {
          console.log(response)
          this.$data.dialog3 = true
        }).catch((err) => {
          console.log(err.response.data)
          if (err.response.data.msg == "Nik sudah digunakan" || err.response.msg == "Email sudah digunakan") { this.message = "NIK atau E-mail sudah digunakan!" }
          ...
          if (err.response.data.msg == "Nik kosong" || err.response.data.msg == "E-mail kosong" || err.response.data.msg == "Password kosong" || err.response.data.msg == "Konfirmasi password kosong" || err.response.data.msg == "Nama kosong" || err.response.data.msg == "Nomor hp kosong" || err.response.data.msg == "Tempat lahir kosong" || err.response.data.msg == "Tanggal lahir kosong" || err.response.data.msg == "Alamat kosong" || err.response.data.msg == "Password dan konfirmasi password tidak sama" || err.response.data.msg == "NIK atau E-mail sudah digunakan") { this.message = err.response.data.msg }
